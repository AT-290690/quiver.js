...
quiv.setNodes({"SERVER":{"key":"SERVER","next":[],"prev":null,"level":0,"type":"root"},"AGE":{"key":"AGE","next":["AGE[POST]"],"prev":null,"level":0,"type":"root"},"AGE[POST]":{"key":"AGE[POST]","next":["AGE[POST](validate)"],"prev":"AGE","level":1,"type":"branch"},"AGE[POST](validate)":{"key":"AGE[POST](validate)","next":["AGE[POST](send)"],"prev":"AGE[POST]","level":2,"type":"branch"},"AGE[POST](send)":{"key":"AGE[POST](send)","next":[],"prev":"AGE[POST](validate)","level":3,"type":"leaf"},"CAT":{"key":"CAT","next":["CAT[GET]","CAT[POST]","CAT[PUT]","CAT[DELETE]"],"prev":null,"level":0,"type":"root"},"CAT[GET]":{"key":"CAT[GET]","next":["CAT[GET][all](validate)","CAT[GET][id](validate)"],"prev":"CAT","level":1,"type":"branch"},"CAT[GET][all](validate)":{"key":"CAT[GET][all](validate)","next":["CAT[GET][all](send)"],"prev":"CAT[GET]","level":2,"type":"branch"},"CAT[GET][all](send)":{"key":"CAT[GET][all](send)","next":[],"prev":"CAT[GET][all](validate)","level":3,"type":"leaf"},"CAT[GET][id](validate)":{"key":"CAT[GET][id](validate)","next":["CAT[GET][id](send)"],"prev":"CAT[GET]","level":2,"type":"branch"},"CAT[GET][id](send)":{"key":"CAT[GET][id](send)","next":[],"prev":"CAT[GET][id](validate)","level":3,"type":"leaf"},"CAT[POST]":{"key":"CAT[POST]","next":["CAT[POST](validate)"],"prev":"CAT","level":1,"type":"branch"},"CAT[POST](validate)":{"key":"CAT[POST](validate)","next":["CAT[POST](send)"],"prev":"CAT[POST]","level":2,"type":"branch"},"CAT[POST](send)":{"key":"CAT[POST](send)","next":[],"prev":"CAT[POST](validate)","level":3,"type":"leaf"},"CAT[PUT]":{"key":"CAT[PUT]","next":["CAT[PUT](validate)"],"prev":"CAT","level":1,"type":"branch"},"CAT[PUT](validate)":{"key":"CAT[PUT](validate)","next":["CAT[PUT](send)"],"prev":"CAT[PUT]","level":2,"type":"branch"},"CAT[PUT](send)":{"key":"CAT[PUT](send)","next":[],"prev":"CAT[PUT](validate)","level":3,"type":"leaf"},"CAT[DELETE]":{"key":"CAT[DELETE]","next":["CAT[DELETE](validate)"],"prev":"CAT","level":1,"type":"branch"},"CAT[DELETE](validate)":{"key":"CAT[DELETE](validate)","next":["CAT[DELETE](send)"],"prev":"CAT[DELETE]","level":2,"type":"branch"},"CAT[DELETE](send)":{"key":"CAT[DELETE](send)","next":[],"prev":"CAT[DELETE](validate)","level":3,"type":"leaf"},"REQUEST":{"key":"REQUEST","next":[],"prev":null,"level":0,"type":"root"}});
import FS from "fs"
const { mkdir, writeFile, access, readFile } = FS.promises
import URL from "url"
import http from "http"

quiv.func["SERVER"] = async (value, key, prev, next) => {
const init = {
routes: {
"/cat": "CAT",
"/age": "AGE"
...
quiv.func["AGE[POST]"] = async (value, key, prev, next) => {
return value.match.method(value, "POST") && value || void 0
}
quiv.func["AGE[POST](validate)"] = async (value, key, prev, next) => {
...
quiv.func["AGE[POST](send)"] = async (value, key, prev, next) => {
...
quiv.func["CAT"] = async (value, key, prev, next) => {
return value.match.url(value, "/cat") && value || void 0
}
quiv.func["CAT[GET]"] = async (value, key, prev, next) => {
return value.match.method(value, "GET") && value || void 0
}
quiv.func["CAT[GET][all](validate)"] = async (value, key, prev, next) => {
return !("id" in value.query) && value || void 0
}
quiv.func["CAT[GET][all](send)"] = async (value, key, prev, next) => {
return value.end(value.res).status(200).send(value.toJSON(await readFile(value.DB_PATH, "utf8")))
}
quiv.func["CAT[GET][id](validate)"] = async (value, key, prev, next) => {
return ("id" in value.query) && value || void 0
}
quiv.func["CAT[GET][id](send)"] = async (value, key, prev, next) => {
...
quiv.func["CAT[POST]"] = async (value, key, prev, next) => {
return value.match.method(value, "POST") && value || void 0
}
quiv.func["CAT[POST](validate)"] = async (value, key, prev, next) => {
if (!value.body) return void (value.end(value.res).status(403).send({ message: "No data provided!"}))
value.body = value.toJSON(value.body)
...
quiv.func["CAT[POST](send)"] = async (value, key, prev, next) => {
const data = await readFile(value.DB_PATH, "utf8")
const json = value.toJSON(data)
...
quiv.func["CAT[DELETE]"] = async (value, key, prev, next) => {
return value.match.method(value, "DELETE") && value || void 0
}
quiv.func["CAT[DELETE](validate)"] = async (value, key, prev, next) => {
return ("id" in value.query) && value || void(value.end(value.res).status(403).send({ message: "No id provided!"}))
}
quiv.func["CAT[DELETE](send)"] = async (value, key, prev, next) => {
const data = await readFile(value.DB_PATH, "utf8")
const json = value.toJSON(data)
const { id } = value.query
...
quiv.func["REQUEST"] = async (value, key, prev, next) => {
