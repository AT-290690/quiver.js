...
quiv.arrows['AGE[POST]'] = async (value, key, prev, next) => {
  return (value.match.method(value, 'POST') && value) || void 0;
};
quiv.arrows['AGE[POST](validate)'] = async (value, key, prev, next) => {
...
quiv.arrows['AGE[POST](send)'] = async (value, key, prev, next) => {
...
quiv.arrows['CAT'] = async (value, key, prev, next) => {
  return (value.match.url(value, '/cat') && value) || void 0;
};
quiv.arrows['CAT[GET]'] = async (value, key, prev, next) => {
  return (value.match.method(value, 'GET') && value) || void 0;
};
quiv.arrows['CAT[GET][all](validate)'] = async (value, key, prev, next) => {
...
quiv.arrows['CAT[GET][id](validate)'] = async (value, key, prev, next) => {
  return ('id' in value.query && value) || void 0;
};
...
quiv.arrows['CAT[POST]'] = async (value, key, prev, next) => {
  return (value.match.method(value, 'POST') && value) || void 0;
};
quiv.arrows['CAT[POST](validate)'] = async (value, key, prev, next) => {
  if (!value.body)
    return void value
      .end(value.res)
      .status(403)
...
quiv.arrows['CAT[PUT]'] = async (value, key, prev, next) => {
  return (
    (value.match.method(value, 'PUT') && 'id' in value.query && value) || void 0
  );
};
quiv.arrows['CAT[PUT](validate)'] = async (value, key, prev, next) => {
  if (!value.body)
    return void value
      .end(value.res)
      .status(403)
...
quiv.arrows['CAT[DELETE]'] = async (value, key, prev, next) => {
  return (value.match.method(value, 'DELETE') && value) || void 0;
};
quiv.arrows['CAT[DELETE](validate)'] = async (value, key, prev, next) => {
  return (
...
quiv.arrows['REQUEST'] = async (value, key, prev, next) => {
