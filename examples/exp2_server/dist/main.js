...
quiv.arrows["AGE[POST]"] = (value, key, prev, next) => {
return value.match.method(value, "POST") && value || void 0
}
quiv.arrows["AGE[POST](validate)"] = (value, key, prev, next) => {
...
quiv.arrows["AGE[POST](send)"] = (value, key, prev, next) => {
...
quiv.arrows["CAT"] = (value, key, prev, next) => {
return value.match.url(value, "/cat") && value || void 0
}
quiv.arrows["CAT[GET]"] = (value, key, prev, next) => {
return value.match.method(value, "GET") && value || void 0
}
quiv.arrows["CAT[GET][all](validate)"] = (value, key, prev, next) => {
return !("id" in value.query) && value || void 0
}
quiv.arrows["CAT[GET][all](send)"] = async (value, key, prev, next) => {
return value.end(value.res).status(200).send(value.toJSON( await  readFile(value.DB_PATH, "utf8")))
}
quiv.arrows["CAT[GET][id](validate)"] = (value, key, prev, next) => {
return ("id" in value.query) && value || void 0
}
quiv.arrows["CAT[GET][id](send)"] = async (value, key, prev, next) => {
...
quiv.arrows["CAT[POST]"] = (value, key, prev, next) => {
return value.match.method(value, "POST") && value || void 0
}
quiv.arrows["CAT[POST](validate)"] = (value, key, prev, next) => {
if (!value.body) return void (value.end(value.res).status(403).send({ message: "No data provided!"}))
value.body = value.toJSON(value.body)
...
quiv.arrows["CAT[POST](send)"] = async (value, key, prev, next) => {
const data =  await  readFile(value.DB_PATH, "utf8")
const json = value.toJSON(data)
...
quiv.arrows["CAT[DELETE]"] = (value, key, prev, next) => {
return value.match.method(value, "DELETE") && value || void 0
}
quiv.arrows["CAT[DELETE](validate)"] = (value, key, prev, next) => {
return ("id" in value.query) && value || void(value.end(value.res).status(403).send({ message: "No id provided!"}))
}
quiv.arrows["CAT[DELETE](send)"] = async (value, key, prev, next) => {
const data =  await  readFile(value.DB_PATH, "utf8")
const json = value.toJSON(data)
const { id } = value.query
