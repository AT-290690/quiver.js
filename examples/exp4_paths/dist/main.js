...
quiv.func["a"] = async (value, key, prev, next) => {
return value
}
quiv.func["g"] = async (value, key, prev, next) => {
return value
}
quiv.func["m"] = async (value, key, prev, next) => {
return value + 15
}
quiv.func["l"] = async (value, key, prev, next) => {
return value - 25
}
quiv.func["b"] = async (value, key, prev, next) => {
return value * 2
}
quiv.func["c"] = async (value, key, prev, next) => {
return value + 3
}
quiv.func["d"] = async (value, key, prev, next) => {
return value + 3
}
quiv.func["e"] = async (value, key, prev, next) => {
return value + 5
}
quiv.func["asad"] = async (value, key, prev, next) => {
return value * 5
};
