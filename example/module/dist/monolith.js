...
_qvr.nodes = {
  ...
  a0: { key: 'a0', next: ['b0'], level: 1, type: 'branch', prev: 'root' },
  b0: { key: 'b0', next: ['c0'], level: 2, type: 'branch', prev: 'a0' },
  c0: { key: 'c0', next: ['d0'], level: 3, type: 'branch', prev: 'b0' },
  d0: { key: 'd0', next: ['e0'], level: 4, type: 'branch', prev: 'c0' },
  e0: { key: 'e0', next: ['f0'], level: 5, type: 'branch', prev: 'd0' },
  f0: { key: 'f0', next: [], level: 6, type: 'leaf', prev: 'e0' },
  a1: { key: 'a1', next: ['b1'], level: 1, type: 'branch', prev: 'root' },
  b1: { key: 'b1', next: ['c1'], level: 2, type: 'branch', prev: 'a1' },
  c1: { key: 'c1', next: ['d1'], level: 3, type: 'branch', prev: 'b1' },
  d1: { key: 'd1', next: ['e1'], level: 4, type: 'branch', prev: 'c1' },
  ...
  m0: { key: 'm0', next: ['m1'], level: 0, type: 'root', prev: 'g1' },
  ...
  amp: { key: 'amp', next: ['amp1'], level: 0, type: 'root', prev: 'toAmp' },
